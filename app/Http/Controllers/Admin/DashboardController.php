...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $topRoutes = DB::table('bookings')
            ...
            ->join('airports as origin', 'schedules.origin_airport_code', '=', 'origin.iata_airport_code')
            ->join('airports as dest', 'schedules.destination_airport_code', '=', 'dest.iata_airport_code')
