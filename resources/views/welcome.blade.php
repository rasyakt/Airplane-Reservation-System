...
<body class="antialiased min-h-screen flex flex-col">
        ...
        <div class="relative bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 overflow-hidden">
            ...
            <div class="container mx-auto px-6 py-20 relative z-10">
                ...
                <div class="max-w-5xl mx-auto">
                    <form id="searchForm" action="{{ route('flights.search') }}" method="GET"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="departure_date" class="input" min="{{ date('Y-m-d') }}"
                                    required>
                            </div>
                        </div>
                    ...
                    <div class="group cursor-pointer">
                        <div class="card hover:scale-105 transition-transform duration-300">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button onclick="viewFlights('{{ $airport->iata_airport_code }}')"
                                    class="text-primary-600 font-semibold text-sm hover:underline focus:outline-none">
                                    View Flights →
                                </button>
                            </div>
                        </div>
            ...
            <div class="container mx-auto px-6">
                <div class="grid md:grid-cols-2 gap-12 items-center mb-20">
                    <div>
                        ...
                        <p class="text-gray-600 mb-6">Already have a reservation? Enter your confirmation code to view
                            your
                    ...
                    <div class="bg-primary-50 p-8 rounded-3xl border-2 border-primary-100">
                        ...
                        <p class="text-sm text-gray-600">Your 10-character confirmation code was sent to your email
                            address
                ...
                <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div class="card text-center">
                        ...
                        <p class="text-gray-600">Compare prices from multiple airlines and get the best deals guaranteed
                        </p>
                    </div>
                    ...
                    <div class="card text-center">
                        ...
                        <p class="text-gray-600">Our customer service team is always ready to help you anytime, anywhere
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-sm">Your trusted partner for flight bookings worldwide. We make travel easy
                        and
                        affordable.</p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="{{ route('pages.show', 'contact') }}" class="hover:text-white">Contact</a>
                        </li>
                        <li><a href="{{ route('pages.show', 'terms') }}" class="hover:text-white">Terms of
                                Service</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="{{ route('pages.show', 'contact') }}" class="hover:text-white">Help
                                Center</a>
                        </li>
                        <li><a href="{{ route('pages.show', 'terms') }}" class="hover:text-white">Terms of
                                Service</a></li>
                        <li><a href="{{ route('pages.show', 'privacy') }}" class="hover:text-white">Privacy
                                Policy</a></li>
                    </ul>
                </div>
                <div>
    ...
    <script>
        function viewFlights(destinationCode) {
            ...
            // Select destination
            destSelect.value = destinationCode;

            // Highlight effect
            destSelect.classList.add('ring-4', 'ring-primary-300', 'transition-all', 'duration-500');
            setTimeout(() => {
                destSelect.classList.remove('ring-4', 'ring-primary-300');
            }, 1000);
        }
    </script>
</body>
